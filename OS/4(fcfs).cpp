...
struct Process{
    ...
    double burst;          // CPU burst time
    double completion = 0;     // completion time
    double waiting = 0;    // waiting time = start − arrival
    double turnaround = 0; // turnaround time = finish − arrival
};
